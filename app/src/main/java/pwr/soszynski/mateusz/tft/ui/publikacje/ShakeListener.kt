...
class ShakeListener(context: Context) : SensorListener {
    ...
    override fun onSensorChanged(sensor: Int, values: FloatArray) {
        ...
        if ((now - mLastTime) > TIME_THRESHOLD) {
            ...
            val speed =
                abs(values[SensorManager.DATA_X] + values[SensorManager.DATA_Y] + values[SensorManager.DATA_Z] - mLastX - mLastY - mLastZ) / diff * 10000
    ...
    companion object {
        private const val FORCE_THRESHOLD = 1500
